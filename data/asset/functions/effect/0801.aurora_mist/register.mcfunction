#> asset:effect/0801.aurora_mist/register
#
# Effectのデータを指定
#
# @within function asset:effect/0801.aurora_mist/_/register

# ExtendsSafe (boolean) (default = false)
    # data modify storage asset:effect ExtendsSafe set value true
# ID (int)
    data modify storage asset:effect ID set value 801
# 名前 (TextComponentString)
    data modify storage asset:effect Name set value '[{"text":"極","color":"#00ffe2"},{"text":"光","color":"#00e2e9"},{"text":"の","color":"#00c5f0"},{"text":"霧","color":"#008bff"}]'
# 説明文 (TextComponentString[])
    data modify storage asset:effect Description set value ['{"text":"MPが高速で減少し、回復もしなくなる"}']
