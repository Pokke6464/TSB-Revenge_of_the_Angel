...
# 数tickごとに攻撃判定が発生
    ...
    execute if score $Interval Temporary matches 0 if entity @a[tag=!PlayerShouldInvulnerable,distance=..6] at @s as @a[distance=..6] run function asset:object/2243.lawless_mist_shot/tick/aoe/damage
