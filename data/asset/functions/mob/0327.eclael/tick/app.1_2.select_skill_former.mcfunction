...
# 簡易魔法
    execute if score @s 93.ActionCount matches 10..11 run tag @s add 93.Skill.Former.ShortMagic
# 連続斬り
    execute if score @s 93.ActionCount matches 12 run tag @s add 93.Skill.Former.Slash
# 曲射
    execute if score @s 93.ActionCount matches 13 run tag @s add 93.Skill.Former.UpperShot
# 待機
    execute if score @s 93.ActionCount matches 14 run tag @s add 93.Skill.Former.Idle
# 魔法
    execute if score @s 93.ActionCount matches 15 run tag @s add 93.Skill.Former.Magic
# 居合斬り
    execute if score @s 93.ActionCount matches 16 run tag @s add 93.Skill.Former.Iai
# 射撃
    execute if score @s 93.ActionCount matches 17 run tag @s add 93.Skill.Former.Shot
# 居眠り
    execute if score @s 93.ActionCount matches 18 run tag @s add 93.Skill.Former.Idle.Sleep