#> asset:mob/0327.eclael/tick/app.skill_events/36_latter_iai/attack_1
#
# アニメーションのイベントハンドラ
#
# @within
...
# ダメージ
    # ダメージ量
        data modify storage api: Argument.Damage set from storage asset:context this.Damage.IaiLatter0
    # 第一属性
...
# 演出
    ...
    execute rotated ~30 ~-40 positioned ^ ^0.5 ^3 run function api:object/summon
    data modify storage api: Argument.ID set value 2001
    data modify storage api: Argument.FieldOverride set value {Item:{id:"stick"},Color:16777088,Frames:[20502,20503,20504],Scale:[8f,4f,3f],Transformation:{left_rotation:{axis:[0,0,1],angle:-0.2f},right_rotation:[0f,0f,0f,1f],translation:[0f,0f,0f]}}
    execute rotated ~-80 ~-60 positioned ^ ^0.5 ^2 run function api:object/summon
    execute rotated ~150 ~-60 positioned ^ ^1 ^1.5 rotated ~180 ~ run function asset:mob/0327.eclael/tick/app.skill_events/36_latter_iai/particle_jump
