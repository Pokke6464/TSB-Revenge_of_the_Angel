#> asset:mob/0327.eclael/tick/app.skill_events/36_latter_iai/main_turn
#
# アニメーションのイベントハンドラ 居合
#
...
# 攻撃
    execute if score @s 93.AnimationTimer matches 1 run function asset:mob/0327.eclael/tick/app.skill_events/36_latter_iai/animation_1
    # プレイヤーの方を向く
    ...
    # 移動
        execute if score @s 93.AnimationTimer matches 1..6 at @s run tp @s ^ ^0.2 ^-1.3
        execute if score @s 93.AnimationTimer matches 10 at @p[tag=!PlayerShouldInvulnerable,distance=..50] facing entity @s feet rotated ~ 0 run function asset:mob/0327.eclael/tick/app.skill_events/36_latter_iai/set_move_position
...
# 攻撃
    # 折り返し前の攻撃判定
        execute if score @s 93.AnimationTimer matches 5 at @a[tag=93.Skill.IaiMove.Hit,distance=..80] run function asset:mob/0327.eclael/tick/app.skill_events/36_latter_iai/attack_0
        execute if score @s 93.AnimationTimer matches 8 at @a[tag=93.Skill.IaiMove.Hit,distance=..80] run function asset:mob/0327.eclael/tick/app.skill_events/36_latter_iai/attack_1
        execute if score @s 93.AnimationTimer matches 11 at @a[tag=93.Skill.IaiMove.Hit,distance=..80] run function asset:mob/0327.eclael/tick/app.skill_events/36_latter_iai/attack_2
        execute if score @s 93.AnimationTimer matches 14 at @a[tag=93.Skill.IaiMove.Hit,distance=..80] rotated ~180 ~ run function asset:mob/0327.eclael/tick/app.skill_events/36_latter_iai/attack_0
        execute if score @s 93.AnimationTimer matches 14 run tag @a remove 93.Skill.IaiMove.Hit
    ...
    execute if score @s 93.AnimationTimer matches 35 unless entity @p[tag=93.Skill.IaiMove.Hit,distance=..80] run function asset:mob/0327.eclael/tick/app.skill_events/36_latter_iai/attack_3
