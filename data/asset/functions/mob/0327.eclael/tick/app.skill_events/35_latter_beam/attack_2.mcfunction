...
# ライン斬撃
    ...
    execute if predicate api:global_vars/difficulty/2_hard run function asset:mob/0327.eclael/tick/app.skill_events/35_latter_beam/attack_line_slash.m {Rotation:120,PosX:0,PosY:0,PosZ:3,IsGreen:"false"}
