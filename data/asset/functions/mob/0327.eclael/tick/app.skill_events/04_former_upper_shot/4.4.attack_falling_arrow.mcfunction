...
# Effect(極光侵蝕・紅)の付与
    ...
    # Effectを付与
        ...
        execute positioned ^ ^ ^ as @a[tag=!PlayerShouldInvulnerable,distance=..3] run function api:entity/mob/effect/give
    # リセット
...
# 紅い雷を召喚
    ...
    data modify storage api: Argument.FieldOverride.Damage set from storage asset:context this.Damage.UpperShot
