...
# 位置決定用Entity召喚
    execute rotated ~ 0 run summon area_effect_cloud ~ ~0.25 ~ {CustomNameVisible:0b,Particle:"block air",Duration:100,Tags:["Object","93.Aec.AttackPos","93.Temp.GeneralTarget"]}

# 拡散
    data modify storage lib: Argument.Bounds set value [[10,10],[0,0],[10,10]]
