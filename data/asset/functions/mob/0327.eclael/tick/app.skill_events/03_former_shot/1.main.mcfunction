...
# 高精度3連射攻撃
    execute if score @s 93.AnimationTimer matches 43 at @a[tag=!PlayerShouldInvulnerable,distance=..80,sort=nearest,limit=1] run summon area_effect_cloud ~ ~ ~ {CustomNameVisible:0b,Particle:"block air",Duration:3,Tags:["Object","93.Aec.AttackPos"]}
    ...
    execute if score @s 93.AnimationTimer matches 45 at @a[tag=!PlayerShouldInvulnerable,distance=..80,sort=nearest,limit=1] run summon area_effect_cloud ~ ~ ~ {CustomNameVisible:0b,Particle:"block air",Duration:3,Tags:["Object","93.Aec.AttackPos"]}
    execute if score @s 93.AnimationTimer matches 47 at @s run function asset:mob/0327.eclael/tick/app.skill_events/03_former_shot/4.1.attack_shot
    execute if score @s 93.AnimationTimer matches 47 at @a[tag=!PlayerShouldInvulnerable,distance=..80,sort=nearest,limit=1] run summon area_effect_cloud ~ ~ ~ {CustomNameVisible:0b,Particle:"block air",Duration:3,Tags:["Object","93.Aec.AttackPos"]}
    execute if score @s 93.AnimationTimer matches 49 at @s run function asset:mob/0327.eclael/tick/app.skill_events/03_former_shot/4.1.attack_shot
...
# 3way攻撃
    ...
    execute if score @s 93.AnimationTimer matches 106 at @s run function asset:mob/0327.eclael/tick/app.skill_events/03_former_shot/4.2.attack_3way_shot
