...
# タイプを切り替える
    execute if entity @s[tag=93.Skill.FieldThunder.ChainType] run return run tag @s remove 93.Skill.FieldThunder.ChainType
    tag @s add 93.Skill.FieldThunder.ChainType