#> asset:mob/0327.eclael/tick/app.skill_events/100_latter_last_attack/attack_2.m
#
# アニメーションのイベントハンドラ
#
# @within function asset:mob/0327.eclael/tick/app.skill_events/100_latter_last_attack/main

# 回転方向や開始地点をわかりやすくするための演出
    $function asset:mob/0327.eclael/tick/app.skill_events/100_latter_last_attack/particle_line.m {Rotation:$(Rotation)}
...
# ライン斬撃Root
    ...
    data modify storage api: Argument.FieldOverride.Damage set from storage asset:context this.Damage.LastAttack2
