...
# 周囲に雷を降らせる
    ...
    execute as @e[type=area_effect_cloud,tag=93.Temp.AttackPosition,distance=..80,sort=nearest,limit=1] at @s run function asset:mob/0327.eclael/tick/app.skill_events/33_latter_moveslash/attack_thunder.m {Distance:12}