...
# 無敵
    execute if score @s 93.AnimationTimer matches 3 run function asset:mob/0327.eclael/tick/app.general/invulnerable/start
# 無敵解除
    execute if score @s 93.AnimationTimer matches 61 run function asset:mob/0327.eclael/tick/app.general/invulnerable/end
...
# 回転斬り
    ...
    # 落雷
        ...
        execute if score @s 93.AnimationTimer matches 192 as @e[type=area_effect_cloud,tag=93.Temp.AttackPosition,distance=..16] at @s run function asset:mob/0327.eclael/tick/app.skill_events/32_latter_fall/attack_check
        execute if score @s 93.AnimationTimer matches 212 as @e[type=area_effect_cloud,tag=93.Temp.AttackPosition,distance=..21] at @s run function asset:mob/0327.eclael/tick/app.skill_events/32_latter_fall/attack_check
        execute if score @s 93.AnimationTimer matches 232 as @e[type=area_effect_cloud,tag=93.Temp.AttackPosition,distance=..26] at @s run function asset:mob/0327.eclael/tick/app.skill_events/32_latter_fall/attack_check
        execute if score @s 93.AnimationTimer matches 252 as @e[type=area_effect_cloud,tag=93.Temp.AttackPosition,distance=..31] at @s run function asset:mob/0327.eclael/tick/app.skill_events/32_latter_fall/attack_check
    # 演出
        execute if score @s 93.AnimationTimer matches 119 run playsound disabled_sounds:item.armor.equip_iron hostile @a ~ ~ ~ 2 0.5
