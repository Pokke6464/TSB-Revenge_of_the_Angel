#> asset:mob/0327.eclael/tick/app.skill_events/34_latter_field_slash/attack_2
#
# アニメーションのイベントハンドラ
#
...
# 攻撃
    ...
    data modify storage api: Argument.FieldOverride.Damage set from storage asset:context this.Damage.FieldSlash1
