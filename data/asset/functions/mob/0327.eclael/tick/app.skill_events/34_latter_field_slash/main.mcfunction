...
# 攻撃
    ...
    # 次元斬に合わせて雷を落とす
        execute if score @s 93.AnimationTimer matches 260 at @a[tag=!PlayerShouldInvulnerable,sort=random,limit=2,distance=..40] run function asset:mob/0327.eclael/tick/app.skill_events/34_latter_field_slash/attack_2
        execute if score @s 93.AnimationTimer matches 310 at @a[tag=!PlayerShouldInvulnerable,sort=random,limit=2,distance=..40] run function asset:mob/0327.eclael/tick/app.skill_events/34_latter_field_slash/attack_2
        execute if score @s 93.AnimationTimer matches 360 at @a[tag=!PlayerShouldInvulnerable,sort=random,limit=2,distance=..40] run function asset:mob/0327.eclael/tick/app.skill_events/34_latter_field_slash/attack_2
        execute if score @s 93.AnimationTimer matches 410 at @a[tag=!PlayerShouldInvulnerable,sort=random,limit=2,distance=..40] run function asset:mob/0327.eclael/tick/app.skill_events/34_latter_field_slash/attack_2
        execute if score @s 93.AnimationTimer matches 460 at @a[tag=!PlayerShouldInvulnerable,sort=random,limit=2,distance=..40] run function asset:mob/0327.eclael/tick/app.skill_events/34_latter_field_slash/attack_2
    # 難易度Blesslessだと次元斬の回数が1増えるのでそれに対応
        execute if score @s 93.AnimationTimer matches 510 if predicate api:global_vars/difficulty/min/3_blessless at @a[tag=!PlayerShouldInvulnerable,sort=random,limit=2,distance=..40] run function asset:mob/0327.eclael/tick/app.skill_events/34_latter_field_slash/attack_2
