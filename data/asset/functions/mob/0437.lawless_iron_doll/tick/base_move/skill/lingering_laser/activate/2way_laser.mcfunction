#> asset:mob/0437.lawless_iron_doll/tick/base_move/skill/lingering_laser/activate/2way_laser
#
#
#
...
# レーザー部分
    execute rotated as @s run function asset:mob/0437.lawless_iron_doll/tick/base_move/skill/lingering_laser/laser/shoot
    execute at @s run tp @s ~ ~ ~ ~50 3
    execute rotated as @s run function asset:mob/0437.lawless_iron_doll/tick/base_move/skill/lingering_laser/laser/shoot
...
# 位置と角度を戻す
    execute positioned ~ ~-1.5 ~ run tp @s ^ ^ ^-2 ~ ~
