...
# 技のリストの初期値
    # ノーマル
        execute if predicate api:global_vars/difficulty/1_normal run data modify storage asset:context this.Skill.List set value [0,1,2,3,80]
    # ハード
        execute if predicate api:global_vars/difficulty/min/2_hard run data modify storage asset:context this.Skill.List set value [0,1,2,3,4,80]
