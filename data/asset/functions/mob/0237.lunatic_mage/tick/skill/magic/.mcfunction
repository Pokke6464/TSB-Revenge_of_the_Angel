...
# リセット
    execute if entity @s[tag=6L.HealthLess15Per,scores={General.Mob.Tick=120..}] run function asset:mob/0237.lunatic_mage/tick/skill/reset
    execute if entity @s[tag=!6L.HealthLess15Per,scores={General.Mob.Tick=150..}] run function asset:mob/0237.lunatic_mage/tick/skill/reset
