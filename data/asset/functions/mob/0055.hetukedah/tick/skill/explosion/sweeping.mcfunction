...
# 警告
    ...
    execute if score @s[tag=1J.ToTheLeft] General.Mob.Tick matches 60 rotated ~25 0 positioned ^ ^0.1 ^7 run function asset:mob/0055.hetukedah/tick/skill/explosion/vfx/alert_shape_mini
    execute if score @s[tag=!1J.ToTheLeft] General.Mob.Tick matches 60 if data storage rota: {RuthlessMode:1b} rotated ~-60 0 positioned ^ ^0.1 ^7 run function asset:mob/0055.hetukedah/tick/skill/explosion/vfx/alert_shape_mini
    execute if score @s[tag=1J.ToTheLeft] General.Mob.Tick matches 60 if data storage rota: {RuthlessMode:1b} rotated ~60 0 positioned ^ ^0.1 ^7 run function asset:mob/0055.hetukedah/tick/skill/explosion/vfx/alert_shape_mini
...
# 爆発
    ...
    execute if score @s[tag=1J.ToTheLeft] General.Mob.Tick matches 80 rotated ~25 0 positioned ^ ^0.2 ^7 run function asset:mob/0055.hetukedah/tick/skill/explosion/explosion_mini
    execute if score @s[tag=!1J.ToTheLeft] General.Mob.Tick matches 80 if data storage rota: {RuthlessMode:1b} rotated ~-60 0 positioned ^ ^0.2 ^7 run function asset:mob/0055.hetukedah/tick/skill/explosion/explosion_mini
    execute if score @s[tag=1J.ToTheLeft] General.Mob.Tick matches 80 if data storage rota: {RuthlessMode:1b} rotated ~60 0 positioned ^ ^0.2 ^7 run function asset:mob/0055.hetukedah/tick/skill/explosion/explosion_mini
