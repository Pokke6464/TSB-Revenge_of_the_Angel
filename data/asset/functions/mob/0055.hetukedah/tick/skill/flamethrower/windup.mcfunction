...
# 反転するかどうかの切り替え
    execute if entity @s[tag=1J.Skill.FlameThrower.ReverseType] run return run tag @s remove 1J.Skill.FlameThrower.ReverseType
    execute if predicate api:global_vars/difficulty/min/2_hard run tag @s add 1J.Skill.FlameThrower.ReverseType
