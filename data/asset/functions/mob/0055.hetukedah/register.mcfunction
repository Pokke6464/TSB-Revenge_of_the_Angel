...
# 名前 (TextComponentString) (オプション)
    data modify storage asset:mob Name set value '[{"text":"ヘトゥケダゥ","color":"dark_red"},{"text":"\\u0002","font":"space"},{"text":"EX","color":"dark_red"}]'
# Mobの説明文 (TextComponentString[]) (オプション)
    data modify storage asset:mob Lore set value ['{"text":"魔の双腕を持つ下級天使。","color":"white"}','{"text":"かつての屈辱を晴らすため、新たに氷の魔法を習得した。","color":"white"}','{"text":"目を離せば、更に増幅した魔力があなたを塵に変えるだろう。","color":"white"}']
# 武器
...
# 体力 (double) (オプション)
    data modify storage asset:mob Health set value 7500
# 攻撃力 (double) (オプション)
...
# 属性倍率 // 1.0fで100% 最低でも25%は軽減されずに入る
    ...
    # 魔法倍率 (float) (オプション)
        data modify storage asset:mob Resist.Magic set value 0.65
    # 火倍率 (float) (オプション)
        data modify storage asset:mob Resist.Fire set value 1.0
    # 水倍率 (float) (オプション)
        data modify storage asset:mob Resist.Water set value 1.1
    # 雷倍率 (float) (オプション)
