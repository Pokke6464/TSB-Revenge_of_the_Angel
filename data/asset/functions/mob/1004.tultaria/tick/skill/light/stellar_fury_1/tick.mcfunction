...
# ランダムなObject2030番を対象として、タグを付与して落下処理をスタートさせる
    execute if score @s General.Mob.Tick matches 50..119 as @e[type=item_display,tag=!2030.Start,scores={ObjectID=2030},sort=random,limit=1] at @s run function asset:mob/1004.tultaria/tick/skill/light/stellar_fury_1/fall_start
